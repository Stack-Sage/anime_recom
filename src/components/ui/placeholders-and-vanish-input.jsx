  ...
  return (
    (<form
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none dark:text-teal-300 bg-transparent text-teal-300 h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
      ...
      <button
        ...
        <motion.svg
          ...
          className="text-teal-300 h-4 w-4">
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="dark:text-teal-500 text-sm sm:text-base font-normal text-teal-400 pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate">
