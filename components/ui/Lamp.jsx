...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        "relative flex min-h-[850px] max-h-full flex-col scale-125 items-center justify-center overflow-hidden bg-transparent w-full rounded-md z-0",
        className
      )}>
      <div
        className="relative flex w-full flex-1 scale-y-150 -scale-x-150 items-center justify-center isolate z-0 ">
        <motion.div
        ...
        <div
          className="absolute top-1/2 h-full w-full translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
        <div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-40 w-64 -translate-y-[6rem] rounded-full bg-cyan-400 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[6.9rem] bg-black  blur-sm  "></motion.div>
